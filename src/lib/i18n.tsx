...
const dict: Record<Lang, Dict> = {
  fr: {
    ...
    "about.p2":
      "Fondé en 2010, notre cabinet réunit des experts issus de la Protection Civile, de l'ingénierie HSE et du Médecin du Travail. Notre mission : aider les entreprises à prévenir les accidents du travail, protéger leurs collaborateurs et bâtir une véritable culture de sécurité.",
    "about.support": "Nous accompagnons les organisations à travers des :",
    "about.value1.t": "Prévention",
    "about.value1.d": "Identifier, évaluer et maîtriser les risques pour éviter qu'ils ne deviennent des accidents ou maladies professionnelles.",
    ...
    "process.s1.t": "Visite de site",
    "process.s1.d": "Diagnostic terrain de vos installations.",
    "process.s2.t": "Analyse des besoins",
    "process.s2.d": "Écoute de vos enjeux et cadrage du projet.",
  ...
  en: {
    ...
    "process.s1.t": "Site Visit",
    "process.s1.d": "On-site diagnostic of your facilities.",
    "process.s2.t": "Needs Assessment",
    "process.s2.d": "Understanding your challenges and scoping the project.",
