...
export function StickyMobileCTA() {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 inset-x-0 z-40 border-t border-border bg-white/95 backdrop-blur px-3 py-2 flex gap-2">
      <a href="tel:+212666249070" className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 rounded-md border border-primary text-primary text-sm font-semibold">
